...
# ros 1
import rospy
from camera_data.msg import ReferencePoses      # geometry_msgs/Point[10]
from sensor_msgs.msg import Image, CameraInfo   # /opt/noetic/include
from cv_bridge import CvBridge, CvBridgeError   # /opt/noetic/include
...
class RefPublisher:
    def __init__(self):
        """
        Give reference points from camera.
        """
