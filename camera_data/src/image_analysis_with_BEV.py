...
class PosePublisher:
    ...
    def image_callback(self, rgb_image):
        ...
        map_x, map_y = self.generate_direct_backward_mapping(world_x_min, world_x_max, world_x_interval, world_y_min, world_y_max, world_y_interval, np.linalg.inv(T_wdc), rgb_intrinsic, cv_rgb)
